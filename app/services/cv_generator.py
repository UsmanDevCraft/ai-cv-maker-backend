...
# Define the explicit, bulletproof prompt engineering template
...
def generate_tailored_assets(
    ...
    try:
        ...
        # Invoke the structured routing mechanism
        result = llm_router.invoke_structured(
            prompt=messages,
            schema=FinalTailoredOutput,
        )
        return result
        ...
        logger.exception("Gemini processing failed via router.")
